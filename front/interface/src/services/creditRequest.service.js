...
const LOAN_COST_API_URL = "http://172.23.4.59:32300/api/v1/totalcost/";
const TRACKING_API_URL = "http://172.23.4.59:32300/api/v1/tracking/";

// get a client by rut to check if it exists
const getClientByRut = (rut) => {
    return axios.get(`http://172.23.4.59:32300/api/v1/users/rut/${rut}`);
};
