...
const API_URL = "http://172.23.4.59:32216/api/v1/CreditRequest/";
const LOAN_COST_API_URL = "http://172.23.4.59:32216/api/v1/loanCost/";

// get a client by rut to check if it exists
const getClientByRut = (rut) => {
    return axios.get(`http://172.23.4.59:32216/api/v1/clients/rut/${rut}`);
};
